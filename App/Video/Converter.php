...
class App_Video_Converter {
    ...
    protected function _initDb() {
        try {
            $this->_db = new App_Db_Mysqli(array(
    ...
    protected function _process() {
        ...
        foreach ($videos as $id => $video) {
            ...
            $filename = App_Video_Downloader::getTmp() . "/video_{$id}";

            if (false === is_file($filename)) {
                $downloader = new App_Video_Downloader($video);
