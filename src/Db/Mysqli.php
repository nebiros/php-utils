...
class Mysqli {
    ...
    public function connect() {
        try {
            ...
            if (false === mysqli_set_charset($this->_resource, $this->getOption("charset"))) {
                throw new \Exception("mysqli_set_charset() function error (" . mysqli_error($this->_resource) . ")");
            }

            if (false === mysqli_select_db($this->_resource, $this->getOption("dbname"))) {
                throw new \Exception("mysqli_select_db() function error (" . mysqli_error($this->_resource) . ")");
            }
        } catch (\Exception $e) {
    ...
    public function disconnect() {
        try {
            if (false === mysqli_close($this->_resource)) {
                throw new \Exception("mysqli_close() function error (" . mysqli_error($this->_resource) . ")");
            }
        } catch (\Exception $e) {
    ...
    public function beginTransaction() {
        @mysqli_query($this->_resource, "SET AUTOCOMMIT = 0");
        @mysqli_query($this->_resource, "BEGIN");
    }
    ...
    public function commit() {
        @mysqli_query($this->_resource, "COMMIT");
    }
    ...
    public function query($query = null, $debug = false) {
        ...
        try {
            ...
            if (false === ($result = mysqli_query($this->_resource, trim($query)))) {
                throw new \Exception("mysqli_query() function error (" . mysqli_error($this->_resource) . ")");
            }
        } catch (\Exception $e) {
        ...
        try {
            foreach ($data AS $column => $value) {
                if ($value === null || strtolower($value) === "null" || $value === "") {
                    ...
                    $data[$column] = "'" . mysqli_real_escape_string($this->_resource, $value) . "'";
                }
            }
        ...
        try {
            ...
            foreach ($data AS $column => $value) {
                if ($value === null || strtolower($value) == "null" || $value == "") {
                    ...
                    $set[] = "`" . $column . "` = '" . mysqli_real_escape_string($this->_resource, $value) . "'";
                }
            }
    ...
    public function lastInsertId($table = null) {
        try {
            ...
            if (false === $result) {
                throw new \Exception(mysqli_error($this->_resource) . " (" . $query . ")");
            }
